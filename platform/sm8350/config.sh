...
# Platform configuration file for Qualcomm Snapdragon 888 devices (SM8350/lahaina)
TARGET_BOARD_API_LEVEL=30

# Partitions
TARGET_BOOT_PARTITION_SIZE=100663296
# Confirmed from the padded images extracted from official SM-F711B/EUX
# Android 15 firmware F711BXXSIJZE5. Cache still requires PIT verification.
